...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-pink-200 via-yellow-100 to-orange-200 flex items-center justify-center px-6 py-12">

//       <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 bg-white/40 backdrop-blur-lg rounded-3xl shadow-2xl p-10 border border-white/50">

//         {/* Left Side - Info */}
//         <div className="space-y-6">
//           <h1 className="text-4xl font-bold text-pink-700 tracking-wide">
//             Contact Rajputi Cloth 👑
//           </h1>
//           <p className="text-gray-700 text-lg">
//             Have questions about our royal collection?
//             Reach out to us and experience the elegance of Rajputi fashion.
//           </p>

//           <div className="space-y-4 mt-6">

//             <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-md hover:scale-105 transition duration-300">
...
//               <span className="text-gray-800 font-medium">info@rajputicloth.com</span>
//             </div>

//             <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-md hover:scale-105 transition duration-300">
//               <FaMapMarkerAlt className="text-red-600 text-xl" />
//               <span className="text-gray-800 font-medium">Jaipur, Rajasthan, India</span>
//             </div>
...
//               className="w-full p-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-400"
//             />
//           </div>
...
//           <button
//             type="submit"
//             className="w-full bg-gradient-to-r from-pink-500 to-orange-500 text-white py-3 rounded-xl font-semibold text-lg shadow-lg hover:scale-105 transition duration-300"
//           >
//             Send Message ✨
//           </button>
//         </form>
